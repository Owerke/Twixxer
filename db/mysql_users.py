...
def get_users():
    ...
    try:
        # Connect to database
        db = Db._db_connect(common.MY_SQL_CONNECTION, common.MY_SQL_USERNAME, common.MY_SQL_PASSWORD, common.DB_NAME)
...
def create_user(user: User):
    ...
    try:
        ...
        cur.execute("INSERT INTO users VALUES (%s, %s, %s, %s, %s, %s, %s, %s)", (user["id"], user["username"], user["firstname"], user["lastname"], user["email"], user["password"], user["created"], user["picture_path"]))
