...
import db.mysql_users as Db_users
import db.mysql_tweets as Db_tweets
import common
...
def _db_connect(host, user, password, database):
...
# Create the database before you do anything
def initialize_database():
    ...
    """
    db = _db_connect(
                host=common.MY_SQL_CONNECTION,
                user=common.MY_SQL_USERNAME,
                password= common.MY_SQL_PASSWORD,
